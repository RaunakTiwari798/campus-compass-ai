...
import { ArrowRight, Code2, GitBranch, Brain, Trophy, Star, Zap, Users, ChevronRight, Terminal, Cpu, Globe } from 'lucide-react'
...
const FEATURES = [
  {
    ...
    description: 'From syntax to advanced algorithms. Interactive lessons with AI-powered feedback.',
    color: 'nova',
    gradient: 'from-nova-400 to-circuit-400',
  },
  {
    icon: Cpu,
    title: 'DSA Academy',
    description: 'Visual algorithm explanations with dry-run debugger. Master every pattern.',
    color: 'plasma',
    gradient: 'from-plasma-400 to-nova-400',
  },
  {
    icon: GitBranch,
    ...
    color: 'circuit',
    gradient: 'from-circuit-400 to-nova-400',
  },
  {
    icon: Globe,
    ...
    color: 'stellar',
    gradient: 'from-stellar-400 to-ember-400',
  },
  {
    icon: Brain,
    title: 'AI Mentor',
    description: 'Your personal tutor available 24/7. Analyzes your mistakes and guides you forward.',
    color: 'plasma',
    gradient: 'from-plasma-400 to-ember-400',
  },
  {
    icon: Trophy,
    ...
    color: 'stellar',
    gradient: 'from-stellar-400 to-circuit-400',
  },
]
      ...
      <pre className="text-white/80 whitespace-pre-wrap">
        {typed.split('\n').map((line, i) => {
          const colorized = line
            ...
            .replace(/\b(def|for|in|return)\b/g, '<span style="color:#7C6EFA">$1</span>')
    ...
    <div className="relative">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="animate-fade-in">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-8"
                ...
                <span className="text-sm text-white/80">AI-Powered Learning Platform</span>
                <Star size={12} className="text-stellar-400" />
              </div>

              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-[1.05] tracking-tight mb-6">
                <span className="text-white">From Beginner to</span>
                <br />
                <span className="text-gradient-plasma">Industry Ready.</span>
              </h1>

              <p className="text-lg text-white/50 max-w-lg mb-10 leading-relaxed">
                Learn coding, build projects, master GitHub, crack interviews, and prepare for GSoC with your personal AI mentor.
              </p>
            ...
            {/* Right: Code editor visualization */}
            <div className="relative animate-slide-up" style={{ animationDelay: '0.3s' }}>
              <div className="relative">
                ...
                {/* Floating UI chips */}
                <div className="absolute -top-4 -right-4 glass px-3 py-2 rounded-xl animate-float"
                  style={{ animationDelay: '1s', borderColor: 'rgba(0,245,160,0.3)' }}>
                ...
                <div className="absolute -bottom-4 -left-4 glass px-3 py-2 rounded-xl animate-float"
                  style={{ animationDelay: '2s', borderColor: 'rgba(0,210,255,0.3)' }}>
                  <div className="flex items-center gap-2">
                ...
                <div className="absolute top-1/2 -right-6 glass px-3 py-2 rounded-xl animate-float"
                  style={{ animationDelay: '3s', borderColor: 'rgba(255,179,71,0.3)' }}>
                  <div className="flex items-center gap-2">
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0"
          style={{ background: 'radial-gradient(ellipse 80% 50% at 50% 50%, rgba(10,10,26,0) 0%, rgba(2,2,10,0.8) 100%)' }} />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-white/40 max-w-xl mx-auto">
              Every tool, resource, and mentor you need to go from writing your first line of code to landing your dream job.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {FEATURES.map((feature) => (
              <div key={feature.title} className="card-glow-plasma p-6 group cursor-pointer">
                <div
      ...
      <section className="relative py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-white/40">Start where you are. We'll take you where you want to go.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {PATHS.map((path) => (
              <button
                ...
                className={`relative group text-left p-8 rounded-2xl transition-all duration-300 ${path.featured ? 'ring-1' : ''}`}
                style={{
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.boxShadow = path.featured ? `0 0 60px ${path.glow}` : 'none'
              ...
              >
                ...
                <div className="text-3xl font-bold mb-2" style={{ color: path.color }}>
                  {path.level}
                </div>
                <p className="text-white/50 text-sm mb-6">{path.description}</p>

                <div className="space-y-2 mb-8">
                  {path.modules.map((module) => (
                    <div key={module} className="flex items-center gap-2 text-sm text-white/60">
      ...
      <section className="relative py-32 overflow-hidden">
        <div className="absolute inset-0"
          style={{
            background: 'radial-gradient(ellipse 80% 80% at 50% 50%, rgba(124,110,250,0.08) 0%, transparent 70%)',
          }} />
